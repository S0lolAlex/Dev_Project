...
public class BotAnswer {
        ...
        switch (receivedMessage) {
            ...
            case "/Chosen":
                if (!preferences.get(message.getChatId()).isUsd() && !preferences.get(message.getChatId()).isEur()) {
                    ...
                    preferences.get(message.getChatId()).setOne(true);
                    preferences.get(message.getChatId()).setCurrency("USD");
                    MESSAGE_MENU.returnMenu(message, "Поточна валюта: " + preferences.get(message.getChatId()).getCurrency());
                } else {
                    preferences.get(message.getChatId()).setOne(true);
                    preferences.get(message.getChatId()).setCurrency("USD");
                    MESSAGE_MENU.returnMenu(message, "Поточна валюта: " + preferences.get(message.getChatId()).getCurrency());
                ...
                break;
            case "9":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()), 9, sender);
                ...
                break;
            case "10":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()), 10, sender);
                preferences.get(message.getChatId()).setTime("10");
                MESSAGE_MENU.returnMenu(message,"Обраний час: " + preferences.get(message.getChatId()).getTime());
                break;
            case"11":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()), 11, sender);
                preferences.get(message.getChatId()).setTime("11");
                MESSAGE_MENU.returnMenu(message,"Обраний час: " + preferences.get(message.getChatId()).getTime());
                break;
            case"12":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()),12, sender);
                preferences.get(message.getChatId()).setTime("12");
                MESSAGE_MENU.returnMenu(message,"Обраний час: " + preferences.get(message.getChatId()).getTime());
                break;
            case"13":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()),13, sender);
                preferences.get(message.getChatId()).setTime("13");
                MESSAGE_MENU.returnMenu(message,"Обраний час: " + preferences.get(message.getChatId()).getTime());
                break;
            case"14":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()), 14, sender);
                preferences.get(message.getChatId()).setTime("14");
                MESSAGE_MENU.returnMenu(message,"Обраний час: " + preferences.get(message.getChatId()).getTime());
                break;
            case"15":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()), 15, sender);
                preferences.get(message.getChatId()).setTime("15");
                MESSAGE_MENU.returnMenu(message,"Обраний час: " + preferences.get(message.getChatId()).getTime());
                break;
            case"16":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()), 16, sender);
                preferences.get(message.getChatId()).setTime("16");
                MESSAGE_MENU.returnMenu(message,"Обраний час: " + preferences.get(message.getChatId()).getTime());
                break;
            case"17":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()),17, sender);
                preferences.get(message.getChatId()).setTime("17");
                MESSAGE_MENU.returnMenu(message,"Обраний час: " + preferences.get(message.getChatId()).getTime());
                break;
            case"18":
                MESSAGE_MENU.startSchedule(message.getChatId(), messageAlert(message.getChatId()),getAnswer(message.getChatId()), 18, sender);
    ...
    private String getAnswer(String chatId){
        ...
        if (preferences.get(chatId).isOne()) {
            answer = preferences.get(chatId).getBank().getCurrency(preferences.get(chatId).getCurrency(), preferences.get(chatId).getDf());
        } else {
